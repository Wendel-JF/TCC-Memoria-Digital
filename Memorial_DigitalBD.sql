...
(DEFAULT,'Wendel', '81dc9bdb52d04dc20036dbd8313ed055','adm',null),
(DEFAULT,'Gabriel Oliveira', '81dc9bdb52d04dc20036dbd8313ed055',"nivel2",null),
(DEFAULT,'Elisson Gabriel','81dc9bdb52d04dc20036dbd8313ed055',"nivel1",null);
/* 1234 
	senha1234
    Feangyjria24533@$
*/
...
select * from personagens where nome LIKE '%allany%' AND idade >= 16 and preço >= 10 AND genero LIKE '%f%';
